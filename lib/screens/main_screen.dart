...
import 'package:covid19information/screens/get_student_info.dart';
...
class _MainPageState extends State<MainPage> {
  ...
  void _getStudentInfoByName() {
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => GetStudentInfoPage('Student Info By Name'),
      ),
    );
  }

  void _getStudentInfoById() {
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => GetStudentInfoPage('Student Info By Id'),
      ),
    );
  }

  void _getAllStudentInfo() {
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => GetStudentInfoPage('All Student Info'),
      ),
    );
  }
}
